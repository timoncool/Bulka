...
stack(
  ...
  note("<c2 [c2 eb2] c2 [bb1 c2]>")
    .s("sawtooth").lpf(400).lpq(4).gain(0.6)
).fast(2).cpm(174)`}
/>
...
stack(
  s("bd*4").bank("RolandTR909"),
  s("cp*3").bank("RolandTR909").gain(0.6),
  s("hh*5").bank("RolandTR909").gain(0.4),
  s("rim*7").bank("RolandTR909").gain(0.3),
  note("c3*3, e3*4, g3*5").s("triangle").room(0.4).gain(0.4)
).cpm(120)`}
/>
